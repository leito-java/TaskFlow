...
public class ProjectService {
    ...
    @Transactional public ProjectResponse create(String name, String icon, String color, String email) { return ProjectResponse.from(repository.save(new Project(name, icon, color, userService.findByEmail(email)))); }
