...
public class ProjectController {
    ...
    @PostMapping @ResponseStatus(HttpStatus.CREATED) public ProjectResponse create(@Valid @RequestBody CreateProjectRequest request, Principal principal) { return service.create(request.name(), principal.getName()); }
}
